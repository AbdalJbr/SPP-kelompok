...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-dark shadow-dark" href="<?= site_url('siswa') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="<?= site_url('paymentsiswa/' . session()->get('id_siswa')) ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">Rp.<?php echo $formattedTotalBelumLunas; ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">Rp.<?php echo $formattedTotalLunas; ?></h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 mt-0 mb-4">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Info Carousel</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                            ...
                            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active" data-bs-interval="10000">
                                        <img src="https://ottopay.id/lkapps/wp-content/uploads/2022/11/40-1-hotelmu-id.png" class="d-block w-100" alt="...">
    ...
    new Chart(ctx3, {
        ...
        data: {
            ...
            datasets: [{
                ...
                fill: true,
                data: [30, 31, 32, 29, 30, 28, 29, 30, 31, 30, 29, 30],
                maxBarThickness: 6
