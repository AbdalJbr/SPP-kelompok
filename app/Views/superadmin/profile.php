...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-dark shadow-dark" href="<?= site_url('profile') ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <div class="col">
                                <div class="card mb-4">
                                    <div class="card-body text-center">
                                        ...
                                        <span class="text-secondary text-xs font-weight-bold"><?= session()->get('name') ?></span><br>
                                        <span class="text-secondary text-xs font-weight-bold"><?= session()->get('username') ?></span><br>
                                        <span class="text-secondary text-xs font-weight-bold"><?= session()->get('role') ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
