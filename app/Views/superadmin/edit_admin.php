        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Admin Tables</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Create Admin</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Create Admin</h6>
            </nav>
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-2">
                            <form role="form" class="text-start" action="<?= base_url('updateadmin/' . $admin['id_admin']); ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="input-group input-group-outline my-2">
                                    <label class="form-label" for="username">Name</label>
                                    <input type="name" class="form-control" name="name" id="name" value="<?= $admin['name']; ?>">
                                </div>
                                <div class="input-group input-group-outline mb-2">
                                    <label class="form-label" for="password">Id</label>
                                    <input type="no_id" class="form-control" name="no_id" id="no_id" value="<?= $admin['no_id']; ?>">
                                </div>
                                <div class="input-group input-group-outline mb-2">
                                ...
                                <div class="input-group input-group-outline mb-2">
                                    ...
                                    <input type="role" class="form-control" name="role" id="role" value="<?= $admin['role']; ?>">
                                </div>
                                <div class="col-sm-10">
