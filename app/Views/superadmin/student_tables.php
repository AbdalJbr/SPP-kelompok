        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Student Tables</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Student Tables</h6>
            </nav>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Student Tables</h6>
                        </div>
                        <a href="<?= site_url('create') ?>" class="badge badge-sm bg-gradient-info">+ Data Siswa</a><br><br>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($siswa as $k) : ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?= $k['tahunajaran']; ?></span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?= $k['tgl_lahir']; ?></span>
                                            </td>
                                            <td class="align-middle text-center text-sm text-info">
                                                <a href="<?= site_url('siswaModel/delete/' . $k['id_siswa']) ?>" class="badge badge-sm bg-gradient-danger">Hapus</a>
                                                <a href="<?= site_url('siswaModel/edit/' . $k['id_siswa']) ?>" class="badge badge-sm bg-gradient-warning">Edit</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
