...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-dark shadow-dark" href="<?= site_url('admintables') ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="<?= site_url('transaction') ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Admin Tables</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Admin Tables</h6>
            </nav>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Admin Tables</h6>
                        </div>
                        <a href="<?= site_url('createadmin') ?>" class="badge badge-sm bg-gradient-info">+ Tambah Admin</a><br><br>
                        <a class="badge badge-sm bg-gradient-dark"> Filter Data Berdasarkan ID</a>
                        <div class="input-group input-group-outline">
                            <input type="text" class="form-control" id="filterInput" placeholder="Filter Data Berdasarkan ID">
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($admin as $k) : ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?= $k['no_id']; ?></span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?= $k['tgl_lahir']; ?></span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?= $k['role']; ?></span>
                                            </td>
                                            <td class="align-middle text-center text-sm text-info">
                                                <a href="<?= site_url('adminModel/deleteadmin/' . $k['id_admin']) ?>" class="badge badge-sm bg-gradient-danger">Hapus</a>
                                                <a href="<?= site_url('adminModel/editadmin/' . $k['id_admin']) ?>" class="badge badge-sm bg-gradient-warning">Edit</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
