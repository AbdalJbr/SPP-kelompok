...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-dark shadow-dark" href="<?= site_url('transactionhistory') ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Transaction History</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Transaction History</h6>
            </nav>
        ...
        <div class="row">
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Transaction History</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-2">
                            <form class="col-md-2" action="<?= base_url('riwayattransaksi'); ?>" method="Get" target="_blank">
								<td>
									Mulai Tanggal <input class="form-control" type="date" name="tgl_awal" value="<?= date('Y-m-d') ?>">
									Sampai Tanggal <input class="form-control" type="date" name="tgl_akhir" value="<?= date('Y-m-d') ?>">
                                    <div class="col-sm-10">
                                    <button type="submit" class="btn bg-gradient-dark shadow-dark">Cetak</button>
                                </div>
								</td>
							</form>
                        </div>
            ...
            <div class="col-lg-6 col-md-6 mt-4 mb-4">
                <div class="card my-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-2">
                            <form class="col-md-2" action="<?= base_url('riwayattransaksi2'); ?>" method="Get" target="_blank">
								<td>
                                    <div class="input-group input-group-outline mb-2">
                                    <select type="keterangan" class="form-control" name="keterangan" id="keterangan">
                                        <option value="keterangan">Lunas</option>
                                        <option value="keterangan">belum lunas</option>
                                    </select>
                                </div>
                                    <div class="col-sm-10">
                                    <button type="submit" class="btn bg-gradient-dark shadow-dark">Cetak</button>
