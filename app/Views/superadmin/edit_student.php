...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-dark shadow-dark" href="<?= site_url('studenttables') ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Student</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Edit Student</h6>
            </nav>
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-2">
                            <form role="form" class="text-start" action="<?= base_url('update/' . $siswa['id_siswa']); ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="input-group input-group-outline my-2">
                                    <label class="form-label" for="username">Name</label>
                                    <input type="name" class="form-control" name="name" id="name" value="<?= $siswa['name']; ?>">
                                </div>
                                <div class="input-group input-group-outline mb-2">
                                    <label class="form-label" for="password">Nis</label>
                                    <input type="nis" class="form-control" name="nis" id="nis" value="<?= $siswa['nis']; ?>">
                                </div>
                                <div class="input-group input-group-outline mb-2">
                                    <label class="form-label" for="password">Kelas</label>
                                    <input type="kelas" class="form-control" name="kelas" id="kelas" <?= $siswa['kelas']; ?>>
                                </div>
                                <div class="input-group input-group-outline mb-2">
                                    <label class="form-label" for="password">Tahun Ajaran</label>
                                    <input type="tahunajaran" class="form-control" name="tahunajaran" id="tahunajaran" value="<?= $siswa['tahunajaran']; ?>">
                                </div>
                                <div class="input-group input-group-outline mb-2">
                                ...
                                <div class="input-group input-group-outline mb-2">
                                    ...
                                    <input type="biaya" class="form-control" name="biaya" id="biaya" value="<?= $siswa['biaya']; ?>">
                                </div>
                                <div class="input-group input-group-outline mb-2">
                                    <label class="form-label" for="password">Role</label>
                                    <input type="role" class="form-control" name="role" id="role" value="<?= $siswa['role']; ?>">
                                </div>
                                <div class="col-sm-10">
                                    <button type="submit" class="btn bg-gradient-dark shadow-dark">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
