                            ...
                            <div class="col-lg-2">
                                <div class="card mb-2">
                                    <div class="card-body text-center">
                                        <img src="https://cdn-icons-png.flaticon.com/512/9654/9654151.png" alt="avatar" class="rounded-circle img-fluid" style="width: 100px;"><br>
                                        <span class="text-secondary text-xs font-weight-bold"><?= $s['name']; ?></span><br>
                                        <span class="text-secondary text-xs font-weight-bold"><?= $s['nis']; ?></span><br>
                                        ...
                                        <?php foreach ($payment as $k) : ?>
                                            <tr data-semester="<?= $k['id_semester']; ?>">
                                                ...
                                                <td class="align-middle text-center text-info">
                                                    <a href="<?= site_url('batal/' . $k['id_spp']) ?>" class="badge badge-sm bg-gradient-danger">Batal</a>
                                                    <?php if ($k['keterangan'] == 'Lunas') : ?>
                                                        <span class="text-success text-xs font-weight-bold">Success</span>
                                                    <?php else : ?>
                                                        <a href="<?= site_url('bayar/' . $k['id_spp']) ?>" class="badge badge-sm bg-gradient-success">Bayar</a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php if ($i > 12) {
