            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        ...
                        <a href="<?= site_url('create2') ?>" class="badge badge-sm bg-gradient-info">+ Data Siswa</a><br><br>
                                    ...
                                    <?php foreach ($siswa as $k) : ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm text-info">
                                                <a href="<?= site_url('siswaModel/delete2/' . $k['id_siswa']) ?>" class="badge badge-sm bg-gradient-danger">Hapus</a>
                                                <a href="<?= site_url('siswaModel/edit2/' . $k['id_siswa']) ?>" class="badge badge-sm bg-gradient-warning">Edit</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
