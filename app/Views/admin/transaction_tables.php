            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        ...
                        <a href="<?= site_url('createtagihan2') ?>" class="badge badge-sm bg-gradient-info">+ Biaya Semester</a><br><br>
                                    ...
                                    <?php foreach ($siswa as $k) : ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm text-info">
                                                <a href="<?= site_url('payment2/' . $k['id_siswa']) ?>" class="badge badge-sm bg-gradient-success">$</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
