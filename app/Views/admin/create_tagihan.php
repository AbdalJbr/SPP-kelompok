...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-dark shadow-dark" href="<?= site_url('transaction2') ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Transaction Tables</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Create School Payment</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Create School Payment</h6>
            </nav>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Create School Payment</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-2">
                            <form role="form" class="text-start" action="<?= site_url('savetagihan2') ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="input-group input-group-outline my-2">
                                    <label class="form-label" for="username">Semester</label>
                                    <input type="semester" class="form-control" name="semester" id="semester">
                                </div>
                                ...
                                <div class="input-group input-group-outline mb-2">
                                    <label class="form-label" for="password">Jatuh Tempo</label>
                                    <input type="jatuhtempo" class="form-control" name="jatuhtempo" id="jatuhtempo">
                                </div>
                                <div class="col-sm-10">
